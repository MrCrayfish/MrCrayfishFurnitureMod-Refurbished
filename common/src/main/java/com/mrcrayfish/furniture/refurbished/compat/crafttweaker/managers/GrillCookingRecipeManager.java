...
public class GrillCookingRecipeManager implements IRecipeManager<GrillCookingRecipe>
{
    ...
    {
        CraftTweakerAPI.apply(new ActionAddRecipe<>(this, new GrillCookingRecipe(CraftTweakerConstants.rl(name), ProcessingRecipe.Category.byName(category), ingredient.asVanillaIngredient(), result.getInternal(), time)));
    }

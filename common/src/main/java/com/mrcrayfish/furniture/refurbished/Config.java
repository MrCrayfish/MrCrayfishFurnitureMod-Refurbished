...
public class Config
{
    ...
    public static class Server
    {
        ...
        public static class Electricity
        {
            ...
            public final IntProperty maximumLinksPerElectricityNode = IntProperty.create(4, 1, 64);
            ...
            public final IntProperty maximumLinksPerElectricityGenerator = IntProperty.create(8, 1, 64);

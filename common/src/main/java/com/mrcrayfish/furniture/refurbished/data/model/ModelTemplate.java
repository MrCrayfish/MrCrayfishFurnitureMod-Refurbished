...
public class ModelTemplate
{
    ...
    public static final ModelTemplate FRYING_PAN = block("frying_pan");
    public static final ModelTemplate FRYING_PAN_HOT = block("frying_pan_hot");
    ...
    public static final ModelTemplate RECYCLE_BIN_CLOSED = block("recycle_bin_closed");
    public static final ModelTemplate RECYCLE_BIN_OPEN = block("recycle_bin_open");
    ...
    public static final ModelTemplate APRICITY_PLATE = block("apricity_plate", TextureSlot.PARTICLE, TextureSlot.TEXTURE);

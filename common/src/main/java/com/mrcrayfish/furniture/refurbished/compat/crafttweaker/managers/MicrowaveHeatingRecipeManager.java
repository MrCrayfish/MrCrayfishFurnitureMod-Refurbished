...
public class MicrowaveHeatingRecipeManager implements IRecipeManager<MicrowaveHeatingRecipe>
{
    ...
    {
        CraftTweakerAPI.apply(new ActionAddRecipe<>(this, new MicrowaveHeatingRecipe(CraftTweakerConstants.rl(name), ingredient.asVanillaIngredient(), result.getInternal(), time)));
    }

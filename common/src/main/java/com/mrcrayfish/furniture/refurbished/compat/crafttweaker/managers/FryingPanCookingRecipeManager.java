...
public class FryingPanCookingRecipeManager implements IRecipeManager<FryingPanCookingRecipe>
{
    ...
    {
        CraftTweakerAPI.apply(new ActionAddRecipe<>(this, new FryingPanCookingRecipe(CraftTweakerConstants.rl(name), ProcessingRecipe.Category.byName(category), ingredient.asVanillaIngredient(), result.getInternal(), time)));
    }

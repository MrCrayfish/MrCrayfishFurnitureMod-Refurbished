...
public class FryingPanCookingRecipeManager implements IRecipeManager<FryingPanCookingRecipe>
{
    ...
    {
        CraftTweakerAPI.apply(new ActionAddRecipe<>(this, new FryingPanCookingRecipe(CraftTweakerConstants.rl(name), ingredient.asVanillaIngredient(), result.getInternal(), time)));
    }

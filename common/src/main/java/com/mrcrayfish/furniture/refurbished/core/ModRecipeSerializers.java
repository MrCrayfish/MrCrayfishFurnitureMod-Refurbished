...
public class ModRecipeSerializers
{
    ...
    public static final RegistryEntry<RecipeSerializer<DoorMatCopyRecipe>> DOOR_MAT_COPY_RECIPE = RegistryEntry.recipeSerializer(Utils.resource("crafting_special_door_mat_copy"), () -> new CustomRecipe.Serializer<>(DoorMatCopyRecipe::new));

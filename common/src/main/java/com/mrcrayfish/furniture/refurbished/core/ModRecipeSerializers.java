...
public class ModRecipeSerializers
{
    ...
    public static final RegistryEntry<SimpleRecipeSerializer<DoorMatCopyRecipe>> DOOR_MAT_COPY_RECIPE = RegistryEntry.recipeSerializer(Utils.resource("crafting_special_door_mat_copy"), () -> new SimpleRecipeSerializer<>(DoorMatCopyRecipe::new));

...
{
    @Override
    public String dumpToCommandString(IRecipeManager<? super SinkFluidTransmutingRecipe> manager, SinkFluidTransmutingRecipe recipe)
    {
        return "%s.addRecipe(%s, %s, %s, %s);".formatted(
            manager.getCommandString(),
            StringUtil.quoteAndEscape(recipe.getId()),
            IFluidStack.of(recipe.getFluid(), 1000).getCommandString(),
    ...
    @Override
    public Optional<IDecomposedRecipe> decompose(IRecipeManager<? super SinkFluidTransmutingRecipe> manager, SinkFluidTransmutingRecipe recipe)
    {
    ...
    @Override
    public Optional<SinkFluidTransmutingRecipe> recompose(IRecipeManager<? super SinkFluidTransmutingRecipe> manager, ResourceLocation id, IDecomposedRecipe recipe)
    {
        ...
        return Optional.of(new SinkFluidTransmutingRecipe(id, fluid, catalyst, result));
    }
}

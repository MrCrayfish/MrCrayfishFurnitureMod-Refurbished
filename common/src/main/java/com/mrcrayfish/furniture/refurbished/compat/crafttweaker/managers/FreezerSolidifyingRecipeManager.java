...
public class FreezerSolidifyingRecipeManager implements IRecipeManager<FreezerSolidifyingRecipe>
{
    ...
    {
        CraftTweakerAPI.apply(new ActionAddRecipe<>(this, new FreezerSolidifyingRecipe(CraftTweakerConstants.rl(name), ingredient.asVanillaIngredient(), result.getInternal(), time)));
    }

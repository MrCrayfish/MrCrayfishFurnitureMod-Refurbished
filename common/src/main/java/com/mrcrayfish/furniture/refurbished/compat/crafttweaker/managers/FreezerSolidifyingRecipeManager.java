...
public class FreezerSolidifyingRecipeManager implements IRecipeManager<FreezerSolidifyingRecipe>
{
    ...
    {
        CraftTweakerAPI.apply(new ActionAddRecipe<>(this, new FreezerSolidifyingRecipe(CraftTweakerConstants.rl(name), "", CookingBookCategory.MISC, input.asVanillaIngredient(), output.getInternal(), experience, cookingTime)));
    }

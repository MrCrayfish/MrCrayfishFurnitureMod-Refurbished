...
public class ToasterToastingCategory extends FurnitureRecipeCategory<ToasterHeatingRecipe>
{
    ...
    @Override
    public void draw(ToasterHeatingRecipe recipe, IRecipeSlotsView view, PoseStack poseStack, double mouseX, double mouseY)
    {
        this.arrow.draw(poseStack, 52, 19);
        this.drawSeconds(poseStack, 64, 38, recipe.getTime());
    }
}

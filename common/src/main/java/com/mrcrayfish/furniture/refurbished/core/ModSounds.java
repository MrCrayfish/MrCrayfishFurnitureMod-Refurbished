...
public class ModSounds
{
    ...
    public static final RegistryEntry<SoundEvent> BLOCK_RECYCLING_BIN_ENGINE = RegistryEntry.soundEvent(Utils.resource("block.recycling_bin.engine"), id -> () -> SoundEvent.createVariableRangeEvent(id));

...
public class ModSounds
{
    ...
    public static final RegistryEntry<SoundEvent> BLOCK_FREEZER_OPEN = RegistryEntry.soundEvent(Utils.resource("block.freezer.open"), id -> () -> SoundEvent.createVariableRangeEvent(id));
    public static final RegistryEntry<SoundEvent> BLOCK_FREEZER_CLOSE = RegistryEntry.soundEvent(Utils.resource("block.freezer.close"), id -> () -> SoundEvent.createVariableRangeEvent(id));
    public static final RegistryEntry<SoundEvent> BLOCK_STOVE_OPEN = RegistryEntry.soundEvent(Utils.resource("block.stove.open"), id -> () -> SoundEvent.createVariableRangeEvent(id));
    ...
    public static final RegistryEntry<SoundEvent> BLOCK_CABINET_OPEN = RegistryEntry.soundEvent(Utils.resource("block.cabinet.open"), id -> () -> SoundEvent.createVariableRangeEvent(id));
    public static final RegistryEntry<SoundEvent> BLOCK_CABINET_CLOSE = RegistryEntry.soundEvent(Utils.resource("block.cabinet.close"), id -> () -> SoundEvent.createVariableRangeEvent(id));

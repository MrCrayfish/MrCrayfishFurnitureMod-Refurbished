...
|   result    |      [IItemStack](https://docs.blamejared.com/1.20.4/en/vanilla/api/item/IItemStack)      |   Yes    |                                                         The item from the result of combinining the `input`, can have an amount and tag                                                         |
| ingredients | [IIngredient[]](https://docs.blamejared.com/1.20.4/en/vanilla/api/ingredient/IIngredient) |   Yes    | An array of ingredients, where the first is the first item to be placed, the last being the final item to craft the `output`. Must have at least 1 ingredient, with a maximum of 5 ingredients. |

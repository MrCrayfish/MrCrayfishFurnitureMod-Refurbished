...
You are now ready to explore further! Head over to the Recipe Types page to learn about all the new recipe types and their functions. If you need extra help, feel free to join our [Discord community](https://discord.gg/mrcrayfish) and post a ticket in `#mod-support` and MrCrayfish or the community will assist you with your problem.